	...
	public void Initialize(){
		...
		btnArco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(BD.selectInventarioP2(BD.selectInventario(user.getNick())) == 1){
					user.setEleccion(2);
					BD.modificarEleccion(user);
		...
		btnBaston.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(BD.selectInventarioP3(BD.selectInventario(user.getNick())) == 1){
					user.setEleccion(3);
					BD.modificarEleccion(user);
		...
		if(BD.selectInventarioP1(BD.selectInventario(user.getNick())) == 1){
